      ...
      >
        ...
        <DialogFooter>
          <Button
            ...
            color="red"
            onClick={handleOpen}
            className="middle none center mr-1 rounded-lg py-3 px-6 font-sans text-xs font-bold text-zen-blue-500 transition-all hover:bg-zen-blue-500/10 active:bg-red-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          >
            <span>Cancel</span>
          </Button>
          <Button
